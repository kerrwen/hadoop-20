...
public class BlockPlacementPolicyDefault extends BlockPlacementPolicy {
 ...
 // public static HashSet<String> favoredRacks = new HashSet<String>();
  ...
  final protected DatanodeDescriptor[] finalizeTargets(
    ...
    System.out.println("finalizetargets");
  ...
  protected DatanodeDescriptor chooseTarget(int numOfReplicas,
                                          ...
                                          boolean newBlock) {
    //added by kerr
     System.out.println("choosetargetdefault");
    //
    if (numOfReplicas == 0 || clusterMap.getNumOfLeaves()==0) {
      return writer;
    }
  ...
  void chooseRandom(int numOfReplicas,
                    ...
                    List<DatanodeDescriptor> results)
    throws NotEnoughReplicasException {
     System.out.println("chooserandom in default");
    int numOfAvailableNodes =
      clusterMap.countNumOfAvailableNodes(nodes, excludedNodes.keySet());
  ...
  public DatanodeDescriptor chooseReplicaToDelete(FSInodeInfo inode,
    ...
    System.out.println("choosereplicatodelete in default");
