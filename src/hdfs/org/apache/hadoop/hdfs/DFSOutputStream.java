...
class DFSOutputStream extends FSOutputSummer implements Syncable, Replicable {
  ...
  private MultiDataOutputStream blockStream;     //客户端向副本复制流水线中第一个存储节点写入数据的IO流  
      ...
      while (!closed && dfsClient.clientRunning) {
        ...
        try {
          ...
          if (blockStream == null) {
            ...
            System.out.println("****Allocating new block****");
 ...
 boolean doParallelWrites, DatanodeInfo[] favoredNodes,
  ...
  private DatanodeInfo[] nextBlockOutputStream(String client) throws IOException {
    ...
    do {
      ...
      System.out.println("****nextBlockOutputStream****");
    ...
    while (true) {
      ...
      while (true) {
        try {
          ...
          System.out.println("****locateFollowingBlock****");
          if (dfsClient.namenodeProtocolProxy != null
